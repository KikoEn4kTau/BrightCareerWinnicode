                    ...
                    <nav className="flex h-[70px] w-full items-start fixed top-[0px] left-[0px] flex items-start justify-start gap-4 shadow-md">
                        ...
                        {auth.user ? (
                            ...
                            <>
                                <Link
                                    href={route('login')}
                                    className="rounded-xl border border-3 border-db px-5 py-1.5 fixed top-[17px] right-[232px] text-db font-semibold hover:bg-db hover:text-white transition-colors duration-200"
                                >
                                    Login
                                </Link>
                                <Link
