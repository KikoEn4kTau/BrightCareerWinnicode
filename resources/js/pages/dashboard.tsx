                                    ...
                                    <div className="flex gap-2">
                                        {Array.from({ length: totalSlides }).map((_, i) => (
                                            <button
                                                ...
                                                className={`w-3 h-3 rounded-full transition-all duration-200 ${i === currentSlide ? 'bg-db' : 'bg-gray-300 hover:bg-gray-400'
                                                    }`}
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
                                    ...
                                    <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl p-6 md:p-8 text-white relative overflow-hidden">
                                        ...
                                        <div className="relative z-10">
                                            ...
                                            <Link className="bg-white text-blue-600 font-semibold px-6 py-2.5 rounded-full hover:bg-blue-50 transition-colors duration-200 text-sm md:text-base" href={route('search')}>
                                                Cari Pekerjaan →
                                            </Link>
                                        </div>
                                    </div>
                                    ...
                                    <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl p-6 md:p-8 text-white relative overflow-hidden">
                                        ...
                                        <div className="relative z-10">
                                            ...
                                            <button className="bg-white text-blue-600 font-semibold px-6 py-2.5 rounded-fullhover:bg-blue-50 transition-colors duration-200 text-sm md:text-base">
                                                Gabung Sekarang →
                                            </button>
                                        </div>
                                    </div>
