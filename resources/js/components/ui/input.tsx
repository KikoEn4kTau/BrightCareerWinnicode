  ...
  return (
    <input
      ...
      className={cn(
        ...
        "selection:text-lb flex h-[45px] w-[541px] min-w-0 rounded-md border bg-transparent",
        "px-3 py-1 text-db shadow-xs transition-[color,box-shadow] outline-none file:inline-flex file:h-7",
